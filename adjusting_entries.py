...
with col1:
    date_1 = st.date_input("Date", datetime.date(2019, 7, 6), key="7", label_visibility="visible")
    date_2 = st.date_input("Date", datetime.date(2019, 7, 6), key="8", label_visibility="collapsed")
