...
with col1:
    date_1 = st.date_input("Date", datetime.date(2019, 7, 6), key="7", format="MM/DD/YY", label_visibility="visible")
    date_2 = st.date_input("Date", datetime.date(2019, 7, 6), key="8", format="MM/DD/YY", label_visibility="visible")
